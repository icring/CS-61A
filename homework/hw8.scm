...
(define (substitute-list s olds news)
    (cond ((null? news) s)
          (else (substitute-list (substitute s (car olds) (car news)) (cdr olds) (cdr news)))))
...
(define (derive-product expr var)
  (make-sum (make-product (addend expr) (derive (augend expr) var)) (make-product (derive (addend expr) var) (augend expr)))  
)
